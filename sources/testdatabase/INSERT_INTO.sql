INSERT INTO TBL_HOUSE (PK_id, TXT_title, projectPrice, projectDeposite) VALUES (?,'Frankreich',100,200);
INSERT INTO TBL_HOUSE (PK_id, TXT_title, projectPrice, projectDeposite) VALUES (?,'Deutschland',200,300);

INSERT INTO TBL_GUEST (PK_id, ID_house, guestName) VALUES (?,1,'Kim');
INSERT INTO TBL_GUEST (PK_id, ID_house, guestName) VALUES (?,2,'Markus');

INSERT INTO TBL_EXPENSE (FK_id, REAL_spend, reason, TXT_when, ID_guest, ID_house) VALUES (?, 200, 'ForFoodAndDrinks', '02/04/2013', 1, 1);
INSERT INTO TBL_EXPENSE (FK_id, REAL_spend, reason, TXT_when, ID_guest, ID_house) VALUES (?, 300, 'ForFoodAndDrinks2', '02/04/2014', 2, 2);
