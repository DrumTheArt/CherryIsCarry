...
import static com.wachs.main.dataAcess.dBQueryGenerators.QueryGeneratorFood.*;

public class TblFoodColumnValidate implements IDbColumnValidator {


    private Statement statement;
    private boolean TblColumnTitleOrderValidate=false;

    public TblFoodColumnValidate() throws SQLException, ClassNotFoundException {
