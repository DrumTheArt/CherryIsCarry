...
public class QueryGeneratorOtherExpensesTest {
    ...
    public void deleteQueryFoodOneGuest_ShouldReturnCorrectQueryString() {
        ...
        //Arrange
        String deleteQueryOneGuest = "DELETE FROM TBL_OTHEREXPENSE WHERE ID_guest=1 AND ID_project = 1 AND REAL_spend = 800.0 AND TXT_reason = 'The second new reason' AND TXT_when = '01.12.2019'";
        QueryGeneratorOtherExpenses otherExpensesQuery = new QueryGeneratorOtherExpenses();
        //Act
        String result = otherExpensesQuery.deleteQueryOtherExpensesOneGuest(1, 1, 800.0, "The second new reason", "01.12.2019");
    ...
    public void updateQueryGuestOneProject_ShouldReturnCorrectQueryString() {
        ...
        //Arrange
        String updateQueryOneGuest = "UPDATE TBL_OTHEREXPENSE SET REAL_spend = 800.0 ,TXT_reason='The second new reason' ,TXT_when = '01.12.2019' WHERE ID_guest = 1 AND ID_project = 1 AND REAL_spend = 200.0 AND TXT_reason = 'The reason' AND TXT_when = '01.01.2019'";
        QueryGeneratorOtherExpenses otherExpensesQuery = new QueryGeneratorOtherExpenses();
        //Act
        String result = otherExpensesQuery.updateQueryOtherExpensesOneGuest(1, 1, 200.0, "The reason", "01.01.2019", 800.0, "The second new reason", "01.12.2019");
