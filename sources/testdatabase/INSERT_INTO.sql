...
INSERT INTO TBL_OTHEREXPENSE (FK_id, REAL_spend, TXT_reason, TXT_when, ID_guest, ID_project) VALUES (?, 200, 'ForFoodAndDrinks', '02/04/2013', 1, 1);
INSERT INTO TBL_OTHEREXPENSE (FK_id, REAL_spend, TXT_reason, TXT_when, ID_guest, ID_project) VALUES (?, 300, 'ForFoodAndDrinks2', '02/04/2014', 2, 2);
